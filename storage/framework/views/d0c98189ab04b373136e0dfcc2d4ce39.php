    ...
    <div>
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm" style="background: #eee; color: #333;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 500;"><?php echo e($detail->variant->product->name); ?></td>
                            <td>
                            ...
                            <td style="font-weight: 500;"><?php echo e(number_format($detail->price * $detail->quantity, 0, ',', '.')); ?>đ</td>
                        </tr>
            ...
            <div class="card-body">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="padding: 10px 0; font-weight: 500;"><?php echo e($order->shipping_name); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; color: #666;">Số điện thoại:</td>
                        <td style="padding: 10px 0;"><?php echo e($order->shipping_phone); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; color: #666;">Địa chỉ:</td>
                        <td style="padding: 10px 0;"><?php echo e($order->shipping_address); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px 0;"><?php echo e(\Carbon\Carbon::parse($order->order_date)->format('d/m/Y H:i')); ?></td>
                    </tr>
                    <tr>
                ...
                <form action="<?php echo e(route('admin.orders.updateStatus', $order->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="1" <?php echo e($order->status == 1 ? 'selected' : ''); ?>>Đang giao</option>
                            <option value="2" <?php echo e($order->status == 2 ? 'selected' : ''); ?>>Hoàn thành</option>
                            <option value="3" <?php echo e($order->status == 3 ? 'selected' : ''); ?>>Đã hủy</option>
                        </select>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-thoitrang\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>