...
<div class="admin-login-card">
        ...
        <form action="<?php echo e(route('admin.login')); ?>" method="POST">
            ...
            <div class="admin-field">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@fashionai.com" required>
                </div>
            </div>
    ...
    <div class="admin-login-footer">
        <a href="<?php echo e(route('home')); ?>"><i class="fa-solid fa-arrow-left"></i> Về trang chủ</a>
    </div>
</div>

</body>
</html><?php /**PATH C:\laragon\www\web-thoitrang\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>