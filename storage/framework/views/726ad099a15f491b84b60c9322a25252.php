...
<div class="auth-card">
    ...
    <div class="form-header">
        ...
        <p>Chúng tôi đã gửi mã 6 số đến<br><span class="email-highlight"><?php echo e(session('reset_email')); ?></span></p>
    </div>
    ...
    <form action="<?php echo e(route('password.verifyOtp')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="resend-link">
        Không nhận được mã?
        <form action="<?php echo e(route('password.sendOtp')); ?>" method="POST" style="display: inline;">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="email" value="<?php echo e(session('reset_email')); ?>">
...
</html><?php /**PATH C:\laragon\www\web-thoitrang\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>