...
<head>
    ...
    <title>Đăng ký - Fashion AI</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .auth-card-image { min-height: 180px; }
...
<div class="auth-card">
    ...
    <div class="auth-card-image">
        ...
        <div class="image-text">
            <h2>Tham gia cùng<br>cộng đồng thời trang</h2>
            <p>Ưu đãi đặc biệt dành cho thành viên mới</p>
        </div>
    </div>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="form-field">
                <div class="input-wrap">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Họ tên" required>
                </div>
                @error('name')
